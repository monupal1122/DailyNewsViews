...
## Complete Stack Deployment (All in Render)

You can deploy both frontend and backend using the included `render.yaml`:

1. Go to [Render Dashboard](https://dashboard.render.com)
2. Create New → Import YAML
3. Upload the `render.yaml` file from frontend folder
